...
def get_cumulative_signals(gcm_cellScaled, panel_info, scRNA_celltype, multiply_nprobe = True):
    ...
    for c in cluster_names:
      ...
      panel_c_sigs = panel_c_sigs.sort_values(by = c, ascending = False) #Rearrange signal in descending order for the current cluster iteration
...
def leiden_corr_matrix (correlation_matrix, edge_corr_threshold = 0.5,
    ...
    return(leiden_partition, new_g, new_vert)
